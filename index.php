    ...
    <div class="desktopNav__tabContainer">
        ...
        <?php endif; ?>
                            ...
                            <li><a class="dropdown-item" href="mostrar_peliculas.php?genero=Bodegón">Bodegón</a></li>
                                            ...
                                            <li class="desktopNav__linkWrapper"><a id="mvl-flyout-button-6"
                                                    class="desktopNav__link mvl-flyout-button"
                                                    href="Subasta/index.php">Subasta</a>
                                                <div class="desktopNav__flyout-container nav-flyout-container-6">
...
<li class="desktopNav__linkWrapper">
                            ...
                            <div class="promo__wrapper">
                                <div class="promo__content">
                                    <figure class="img__wrapper promo__logo"><img
                                            src="media/Paint-Palette-Vector-PNG-File.png"
                                            srcSet="" alt="" />
                                    </figure>
                                    <div class="promo__content__main">
                                        <div class="promo__title">Donde la locura se encuentra con el lienzo </div>
                            ...
                            <div class="baseCarousel__wrapper">
                                ...
                                <div class="carousel__content">
                                    <div class="carousel__slide">
                                        <img src="media/uno.png" alt="Vaniofrenicos">
                                    </div>
                    
                                    <div class="carousel__slide">
                                        <img src="media/dos.jpg" alt="Arte">
                                    </div>
                    
                                    <div class="carousel__slide">
                                        <img src="media/tres.jpg" alt="Descripción de la imagen 3">
                                    </div>

                                    <div class="carousel__slide">
                                        <img src="media/cuatro.jpg" alt="Descripción de la imagen 3">
                                    </div>

                                    <div class="carousel__slide">
                                        <img src="media/cinco.jpg" alt="Descripción de la imagen 3">
                                    </div>
    ...
    <ul class="tabs__container">
        <li class="tabs__btns "><a role="button" tabindex="0">Las Obras Destacadas en Vaniofrénicos Espacio</a></li>
        <li class="tabs__btns "><a role="button" tabindex="0">Colecciones de Arte de la Semana</a></li>
        <li class="tabs__btns "><a role="button" tabindex="0">Artistas Emergentes del Mes</a></li>
        <li class="tabs__btns "><a role="button" tabindex="0">Exclusivas Ofertas de Arte en Vaniofrénicos</a></li>
    </ul>
</div>
...
<div class="social-links-wrapper">
    <div class="social-links social">
        <!-- Facebook Icon -->
        <a target="_blank" aria-label="follow us on Facebook, opens a new window" class="social__img" href="https://www.facebook.com">
            <i class="fab fa-facebook-square" style="color: #4267B2; font-size: 24px;"></i>
        </a>
        <!-- Twitter Icon -->
        <a target="_blank" aria-label="follow us on Twitter, opens a new window" class="social__img" href="https://twitter.com/home">
            <i class="fab fa-twitter-square" style="color: #1DA1F2; font-size: 24px;"></i>
        </a>
        <!-- Instagram Icon -->
        <a target="_blank" aria-label="follow us on Instagram, opens a new window" class="social__img" href="https://www.instagram.com/">
            <i class="fab fa-instagram-square" style="color: #E1306C; font-size: 24px;"></i>
        </a>
        <!-- Pinterest Icon -->
        <a target="_blank" aria-label="follow us on Pinterest, opens a new window" class="social__img" href="https://www.pinterest.com">
            <i class="fab fa-pinterest-square" style="color: #E60023; font-size: 24px;"></i>
        </a>
        <!-- LinkedIn Icon -->
        <a target="_blank" aria-label="follow us on LinkedIn, opens a new window" class="social__img" href="https://www.linkedin.com">
    ...
    <div class="sets__container" aria-live="polite" role="region">
        ...
        <div class="sets__eyebrow">Explora Obras Maestras</div>
        <div class="sets__title">Descubre Arte que Inspira en Vaniofrénicos Espacio</div>
        <div class="sets__description">Cada obra es una ventana a nuevas perspectivas y emociones. ¡Experimenta la belleza y profundidad del arte en nuestra colección única!</div>
        <a target="_self" class="ctaa-btn ctaa-btn--outline cta-btn--light" href="tienda.php"><span class="innerFill"><span>Explorar Colección</span></span></a>
    </div>
</div>
...
<!-- Nuestros Servicios Artísticos -->
<br><br>
<div class="promo__eyebrow" style="font-size:28px; text-align:center;">Nuestros Servicios Artísticos</div>
<br>
<div id="tarjetas">
  <div class="card-deck">
    <div class="card">
      <img src="media/gallery.jpg" class="card-img-top" alt="Galería de Arte" style="width: 400px;">
      <div class="card-body">
        <h5 class="card-title">Galería de Arte Virtual</h5>
        <p class="card-text">Explora nuestra colección de arte desde la comodidad de tu hogar. Ofrecemos una galería virtual interactiva con obras de artistas emergentes y establecidos de todo el mundo.</p>
        <p class="card-text"><small class="text-muted">Visitas Virtuales y Exhibiciones</small></p>
      </div>
    </div>
    <div class="card">
      <img src="media/auction.jpg" class="card-img-top" alt="Subasta de Arte" style="width: 400px;">
      <div class="card-body">
        <h5 class="card-title">Subastas en Línea</h5>
        <p class="card-text">Participa en nuestras emocionantes subastas de arte en línea. Adquiere piezas únicas en un entorno dinámico y competitivo.</p>
        <p class="card-text"><small class="text-muted">Subastas en Vivo y Pujas Online</small></p>
      </div>
    </div>
    <div class="card">
      <img src="media/art_consulting.jpg" class="card-img-top" alt="Consultoría de Arte" style="width: 400px;">
      <div class="card-body">
        <h5 class="card-title">Consultoría de Arte</h5>
        <p class="card-text">Te asesoramos en la selección de arte para tu colección, inversiones y decoración de espacios. Nuestros consultores son expertos en el mercado del arte.</p>
        <p class="card-text"><small class="text-muted">Servicios Personalizados de Consultoría</small></p>
      </div>
    </div>
  </div>
</div>
<br><br><br>
                    ...
                    <!-- Tabla con imágenes -->
                    <section id="promo-10">
                    <div class="promo__eyebrow" style="font-size:28px;">Exclusividad en Vaniofrénicos Espacio</div>
                    <p>Descubre una selección curada de arte original, desde pinturas clásicas hasta obras contemporáneas únicas. Solo en Vaniofrénicos Espacio.</p>
                    ...
                    <section id="promo-8"
                        ...
                        <div class="promo dark featured longer ">
                            <div class="promo__wrapper">
                                ...
                                <div class="promo__content">
    <div class="promo__content__main">
        <div class="promo__eyebrow">Vaniofrénicos Espacio</div>
        <div class="promo__title">Explora el Mundo del Arte con Vaniofrénicos Espacio: Tu Conexión con el Arte Contemporáneo</div>
        <div class="promo__description">
            ¡Estamos aquí para enriquecer tu experiencia artística! En Vaniofrénicos Espacio valoramos tu pasión por el arte y queremos asegurarnos de que descubras obras que te inspiren y emocionen. Si tienes preguntas sobre nuestras colecciones, artistas o servicios, no dudes en contactarnos. Te ayudaremos a encontrar esa pieza perfecta:​
        </div>
        <a target="_self" class="ctaa-btn ctaa-btn--outline cta-btn--light" href="Contactanos/index.php"><span class="innerFill"><span>Contactanos</span></span></a>
    </div>
    ...
    <!-- Nuestros Valores en el Arte -->
<br><br>
<div class="promo__eyebrow" style="font-size:28px; text-align:center;">Nuestros Valores</div>
<br>
<section class="aspectos-positivos">
    <div class="aspecto">
    ...
    <div class="aspecto">
        ...
        <p>Curación y Autenticidad</p>
    </div>
    <div class="aspecto">
        <i class="fas fa-award"></i>
        <p>Excelencia Artística</p>
    </div>
    <div class="aspecto">
        <i class="fas fa-heart"></i>
        <p>Compromiso con los Artistas</p>
    </div>
    <div class="aspecto">
        <i class="fas fa-users"></i>
        <p>Comunidad y Colaboración</p>
    </div>
</section>
