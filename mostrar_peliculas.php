...
<div class="promo__eyebrow" style="font-size:28px; text-align:center;">Cateogrías</div>
<p style="margin-left: 80px; margin-right: 80px;">
  Descubre la diversidad del arte en Vaniofrénicos Espacio, donde cada categoría de pintura revela su propio lenguaje visual y emocional. Desde los sutiles matices de los <strong>Retratos</strong>, que capturan la esencia y el espíritu humano, hasta los vastos y serenos <strong>Paisajes</strong> que evocan la majestuosidad de la naturaleza. No te pierdas la riqueza de los <strong>Bodegones</strong>, con su detallada y estudiada composición que celebra la belleza de lo cotidiano. Cada género ofrece una perspectiva única y un deleite estético, ya sea para el coleccionista serio o el nuevo aficionado al arte. Sumérgete en la experiencia de cada categoría y encuentra esa obra especial que resonará contigo y embellecerá tu entorno.
</p>
<br><br>	
<?php
...
$sql = "SELECT * FROM arte WHERE genero = ?";
...
if ($resultado->num_rows > 0) {
    ...
    echo "var_dump($generoSeleccionado)";
}
?>
</div>
