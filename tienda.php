...
<span class="user-menu-tab" style="text-decoration: none;">¡Únete!</span>
</a>
<?php endif; ?>
</div>
...
<br><br><br><br><br>
                    <div class="promo__eyebrow" style="font-size:28px; text-align:center;">Galería de Arte</div>
                    <p style="margin-left: 80px; margin-right: 80px;">
  Explora nuestra selecta galería en Vaniofrénicos Espacio, donde cada obra de arte es una ventana a mundos únicos y expresiones inolvidables. Nuestra colección abarca desde las grandes obras maestras hasta las joyas ocultas de artistas emergentes. Cada pieza ha sido cuidadosamente seleccionada para asegurar que experimentes la diversidad de técnicas y narrativas visuales, ideales para enriquecer cualquier espacio o inspirar cualquier momento. Nuestro compromiso es ofrecerte no solo decoración, sino también la oportunidad de conectar con el arte y cultivar tu pasión por la estética y la creatividad.
</p>			
<br><br>
        <!-- Películas ----------------------------------------------------------------------------- -->
...
$resultado = $conexion->query("SELECT * FROM arte");
        ...
        if (isset($_SESSION['username']) && !empty($_SESSION['username'])) {
            ...
            echo "<div class='item' data-cantidad-existencia='{$pelicula['cantidad_existencia']}'>
                ...
                <div class='info-product'>
                    ...
                    <p>Identificador Único: {$pelicula['id']}</p>
                        ...
                        <div class="main-footer__full-content">
                            <div class="main-footer__links"><a class="main-footer__logo" href="index.html">
                                ...
                                <nav class="main-footer__secondary-links" aria-label="Secondary footer navigtion">
                                    <ul>
                                        ...
                                        <li class="main-footer__link"><a href="#">Vaniofrénicos.com</a></li>
                                    </ul>
                                </nav>
                            </div>
                            <nav class="main-footer__promo-links" aria-label="Promotional footer navigtion">
                                <div class="main-footer__promotion">
                                        <div class="main-footer__promotion-image-wrapper">
                                            <figure class="img__wrapper "><img
                                                    src="media/art_palette_icon.png" style="width: 40px; height: 40px; margin-left: 25px;" 
                                ...
                                <div class="main-footer__promotion">
                                        ...
                                        <div class="main-footer__promotion-image-wrapper">
                                            <figure class="img__wrapper "><img
                                                    src="media/art_exhibition_icon.png" style="width: 40px; height: 40px; margin-left: 25px;"
